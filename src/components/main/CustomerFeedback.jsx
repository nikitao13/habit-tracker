function CustomerFeedback() {
  return (
    <section className="flex h-[25vh] w-full select-none items-center justify-center bg-white sm:h-[30vh]">
      <div className="flex w-full flex-col items-center gap-4 px-4 text-center sm:w-2/3 sm:gap-8">
        ...
        <h2 className="text-[0.8rem] tracking-wider sm:text-base">
