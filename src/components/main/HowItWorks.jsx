function HowItWorks() {
  return (
    <section className="mx-auto flex h-[65svh] w-full select-none flex-col bg-white px-4 py-4 antialiased sm:mt-0 sm:h-[40vh] sm:justify-center sm:bg-gray-100 sm:py-0 sm:pb-0">
