function GetStarted() {
  return (
    <section className="select-none antialiased flex flex-col items-center justify-center w-full h-[20vh] sm:h-[25vh] mx-auto bg-gray-100">
